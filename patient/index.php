        ...
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-session">
                        <a href="#" class="non-style-link-menu" onclick="openChatbotModal()"><div><p class="menu-text">SleepTight Bot</p></div></a>
                    </td>
                </tr>
            ...
            <div id="chatbotModal" class="modal">
                <div class="modal-content">
                    ...
                    <h2 class="modal-header">Ask SleepTight Bot about Sleep Apnea!</h2>
